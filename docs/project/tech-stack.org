...
- *LSP:* Required — Language Server Protocol for code intelligence interactions
...
- *Format:* Org-mode (.org) for project documentation
- *Rationale:* Human-readable, supports structured documents, version-controllable
